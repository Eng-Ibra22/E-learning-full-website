...
<header class="bg-white dark:bg-brandBlue shadow px-6 py-4 flex justify-between items-center">
    ...
    <div class="flex gap-6 items-center">
        <a href="home.html" class="font-bold text-brandBlue dark:text-white">Home</a>
        <a href="dashboard.php" class="font-bold text-brandBlue dark:text-white">Dashboard</a>

        <!-- Dark Mode Button -->
        <button id="theme-toggle"
            class="bg-brandBlue text-white px-3 py-2 rounded-md">
